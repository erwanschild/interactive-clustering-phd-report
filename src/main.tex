...
\definecolor{darkyellow}{rgb}{0.60, 0.53, 0.05}
...
\newenvironment{leftBarWarning}{
	...
	\noindent
	\textbf{\textcolor{colorLeftBarWarning}{\faExclamationTriangle}~Attention~\textcolor{colorLeftBarWarning}{\faExclamationTriangle}}~:
}{
    \end{leftbar}
...
\newenvironment{leftBarIdea}{
	...
	\noindent
	\textbf{\textcolor{colorLeftBarIdea}{\faLightbulb}~Idée~\textcolor{colorLeftBarIdea}{\faLightbulb}}~:
}{
    \end{leftbar}
...
\newenvironment{leftBarAuthorOpinion}{
	...
	\noindent
	\textbf{\textcolor{colorLeftBarAuthorOpinion}{\faCommentDots}~Avis de l'auteur~\textcolor{colorLeftBarAuthorOpinion}{\faCommentDots}}~:
}{
    \end{leftbar}
...
\newenvironment{leftBarInformation}{
	...
	\noindent
	\textbf{\textcolor{colorLeftBarInformation}{\faInfoCircle}~Pour information~\textcolor{colorLeftBarInformation}{\faInfoCircle}}~:
}{
    \end{leftbar}
...
%%% Pour le code Python:
\usepackage{listings}
\definecolor{colorCodeString}{rgb}{0.60, 0.00, 0.00}
\definecolor{colorCodeComment}{rgb}{0.00 ,0.50, 0.00}
\definecolor{colorCodeKeyword}{rgb}{0.00, 0.00, 1.00}
\definecolor{colorCodeEmphasize}{rgb}{0.97, 0.15, 0.45}
\definecolor{colorCodeBackground}{rgb}{0.90, 0.90, 0.90}
...
\lstset{
  ...
  backgroundcolor=\color{colorCodeBackground},
