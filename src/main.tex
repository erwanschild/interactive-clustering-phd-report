...
\Rapporteurs ={
    Dr. Thomas LAMPERT (ok!)\\
    Dr. (avoir une femme !)
}
\Examinateurs={
    Dr. Adrien COULET (à demander)\\
    Dr. Pascale KUNTZ-COSPEREC (à demander)
}
\Encadrants={
...
%%%%%--------------------------------------------------------------------
\input{chapters/1_etat_de_l_art.tex}

%%%%%--------------------------------------------------------------------
%%%%% Chapitre 2: Clustering Interactif
%%%%%--------------------------------------------------------------------
\input{chapters/2_clustering_interactif.tex}

%%%%%--------------------------------------------------------------------
%%%%% Chapitre 3: Etude de la méthode
%%%%%--------------------------------------------------------------------
\input{chapters/3_etudes.tex}
