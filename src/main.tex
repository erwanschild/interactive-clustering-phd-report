...
\begin{document}
	...
	%%%
	\AddLab{
		En partenariat avec l'entreprise Euro Information, groupe Crédit Mutuel Alliance Fédérale
	}
	...
	%%%%%--------------------------------------------------------------------
	%%%%% Page de financements
	%%%%%--------------------------------------------------------------------

	% \WriteThisInToc
	\input{chapters/financements.tex}
	...
	%%%%%--------------------------------------------------------------------
	\input{chapters/2.0_etat_de_l_art.tex}

	%%%%%--------------------------------------------------------------------
	%%%%% Chapitre: Clustering Interactif
	%%%%%--------------------------------------------------------------------
	\input{chapters/3.0_clustering_interactif.tex}

	%%%%%--------------------------------------------------------------------
	%%%%% Chapitre: Etude de la méthode
	%%%%%--------------------------------------------------------------------
	\input{chapters/4.0_etudes.tex}

	%%%%%--------------------------------------------------------------------
	%%%%% Chapitre: Guide d'utilisation
	%%%%%--------------------------------------------------------------------
	\input{chapters/5.0_guide_utilisation.tex}

	%%%%%--------------------------------------------------------------------
	%%%%% Conclusion
	%%%%%--------------------------------------------------------------------
	\input{chapters/6.0_conclusion.tex}
	...
	\PutLineInToc
	\input{chapters/annexes_0_sommaire.tex}
