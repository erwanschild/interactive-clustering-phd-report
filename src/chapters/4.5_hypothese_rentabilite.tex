	...
	\label{section:4.5.1-ETUDE-RENTABILITE-ACCORD-ANNOTATION-CLUSTERING}
		...
		\subsubsection{Résultats obtenus}
			...
			\begin{table}[!htb]
				...
				\end{tabular}
				\end{center}
				\caption{Score de corrélation \texttt{r} de \textit{Pearson} entre la performance du \textit{clustering} obtenu à l'aide d'une vérité terrain (\texttt{v-measure}) et le score d'accord entre annotation et \textit{clustering}.
				}
	...
	\label{section:4.5.2-ETUDE-RENTABILITE-SIMILARITE-CLUSTERING}
		...
		\subsubsection{Résultats obtenus}
			...
			\begin{table}[!htb]
				...
				\end{tabular}
				\end{center}
				\caption{Score de corrélation \texttt{r} de \textit{Pearson} entre la performance du \textit{clustering} obtenu à l'aide d'une vérité terrain (\texttt{v-measure}) et le score de différence entre deux \textit{clusterings} consécutifs.
				}
