...
\label{section:2.3-DEFIS-ANNOTATION}
	...
	\label{section:2.3.1-DEFIS-ANNOTATION-ASPECT-DONNEES}
		...
		\label{section:2.3.1.C-DEFIS-ANNOTATION-ASPECT-DONNEES-DROITS}
			...
			Ces limites concernent aussi la Réglementation Générale européenne sur la Protection des Données (\cite{european-commission:2016:regulation-eu-2016}) restreignant les \textbf{collectes et usages non consenties} de données personnelles.
			...
			\begin{leftBarInformation}
				Pour terminer nous mentionnons aussi une proposition de législation européenne concernant la futures réglementation des modèles d'intelligence artificielle (\cite{european-commission:2021:proposal-regulation-european}).
	...
	\label{section:2.3.3-DEFIS-ANNOTATION-ASPECT-HUMAIN}
		...
		\label{section:2.3.3.A-DEFIS-ANNOTATION-ASPECT-HUMAIN-INTER-ANNOTATEURS}
			...
			\cite{bayerl-paul:2011:what-determines-intercoder} ont pu étudier un ensemble de \textbf{facteurs source de désaccords}.
		...
		\label{section:2.3.3.C-DEFIS-ANNOTATION-ASPECT-HUMAIN-ESCLAVAGE}
			...
			% Introduction: on a besoin d'experts.
			...
			Tout d'abord, on peut remarquer que ces opérateurs sont souvent payés un salaire dérisoire proportionnel à la quantité de données qu'ils labellisent.
