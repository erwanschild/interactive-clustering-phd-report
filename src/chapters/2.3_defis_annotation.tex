	...
	\label{section:2.3.1-DEFIS-ANNOTATION-ASPECT-DONNEES}
		...
		\label{section:2.3.1.A-DEFIS-ANNOTATION-ASPECT-DONNEES-REPRESENTATIVITE}
			...
			\begin{leftBarExamples}
				...
				Toutefois, cette base d'apprentissage ne sera plus représentative si nous voulons détecter la langue de la bande dessinée (auquel cas, une répartition par langue sera \textit{a priori} plus adéquate).
			\end{leftBarExamples}
