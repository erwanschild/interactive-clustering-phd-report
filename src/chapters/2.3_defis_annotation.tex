...
\label{section:2.3-DEFIS-ANNOTATION}
	...
	\label{section:2.3.2-DEFIS-ANNOTATION-ASPECT-COMPLEXITE}
		...
		\label{section:2.3.2.C-DEFIS-ANNOTATION-ASPECT-COMPLEXITE-COUTS}
			...
			\begin{itemize}
				\item le temps nécessaire à la collecte de données, pouvant prendre plusieurs semaines celle-ci correspond à un sondage ou à une mesure d'un phénomène s'étalant sur la durée ;
				\item le temps imposé par les ateliers de conception de la modélisation, pouvant prendre entre quelques heures et quelques semaines en fonction de sa complexité et des différences d'opinions entre experts ;
				\item le temps dédié à l'annotation, dépendant entre autre de la complexité de la modélisation et de la quantité de données à labelliser ;
	...
	\label{section:2.3.3-DEFIS-ANNOTATION-ASPECT-HUMAIN}
		...
		\label{section:2.3.3.A-DEFIS-ANNOTATION-ASPECT-HUMAIN-INTER-ANNOTATEURS}
			...
			\todo[inline]{intervention de la subjectivité}
				...
				% > [bayerl-paul:2011:what-determines-intercoder] plus il y a d'étiquettes 
			...
			\todo[inline]{quelques solutions palliatives: évaluation, redondances}
				% revue des conflits, adjudication, guide dfiable
