	...
	\label{section:4.2.1-ETUDE-OPTIMISATION}
		...
		\subsubsection{Protocole expérimental}
			...
			\begin{algorithm}
				...
				%
				\caption{\textit{Description en pseudo-code du protocole expérimental de l'étude d'optimisation de la convergence du \textit{clustering} interactif vers une vérité terrain pré-établie.}}
