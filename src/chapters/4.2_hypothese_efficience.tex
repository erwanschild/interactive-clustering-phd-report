\section{Hypothèse d'efficience : « \textit{quels sont les paramètres optimaux pour minimiser la charge de travail de l'annotateur ?} »}
\label{section:4.2-HYPOTHESE-EFFICIENCE}

	\todo[inline]{
		TITRE A REVOIR:
		quels sont les paramètres optimaux pour accélérer la convergence de la méthode ?
		quels sont les paramètres optimaux pour minimiser la charge de travail de l'annotateur ?
	}
