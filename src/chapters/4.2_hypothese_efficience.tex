	...
	\label{section:4.2.1-ETUDE-OPTIMISATION}
		...
		\subsubsection{Discussion}
			...
			\begin{leftBarAuthorOpinion}
				...
				Nous notons que les facteurs de prétraitements et de vectorisation sont significatifs possèdent toutefois de faibles valeurs de variance expliquée ($\eta^{2} < 0.40$).
			...
			Cela peut être la cas avec des \textit{cluster} traitant en fin de compte de sujets très similaires (\textit{ajouter des \texttt{MUST-LINK} pour les fusionner}) ou avec un \textit{cluster} qui regroupe finalement plusieurs thématiques (\textit{ajouter des \texttt{CANNOT-LINK} pour le segmenter})
