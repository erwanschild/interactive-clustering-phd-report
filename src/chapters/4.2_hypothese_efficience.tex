...
% « \textit{quels sont les paramètres optimaux pour minimiser la charge de travail de l'annotateur ?} »
	...
	\label{section:4.2.1-ETUDE-OPTIMISATION}
		...
		\subsubsection{Protocole expérimental}
			...
			Nous utilisons toujours le jeu de données \texttt{bank cards (v1.0.0)} (cf. annexe~\ref{annex:C.1-DATASET-BANK-CARDS}) comme vérité terrain, sur lequel nous testons $192$ combinaisons de paramétrage, et chaque tentative est répétée $5$ fois pour contrer les aléas statistiques de certains algorithmes.
