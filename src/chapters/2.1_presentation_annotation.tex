...
\label{section:2.1-PRESENTATION-ANNOTATION}
	...
	\label{section:2.1.1-PRESENTATION-ANNOTATION-DEFINITION}
		...
		\label{section:2.1.1.B-PRESENTATION-ANNOTATION-DEFINITION-BASE-APPRENTISSAGE}
			...
			Nous utilisons alors les termes \textguillemets{\texttt{corpus d'entraînement}}, \textguillemets{\texttt{jeu d'entraînement}} ou \textguillemets{\texttt{base d'apprentissage}} pour désigner cet ensemble de données.
			...
			Il est donc d'usage de valoriser cet échantillon s'il est \textguillemets{\texttt{représentatif}} du phénomène qu'il décrit, c'est-à-dire s'il capture bien le large éventail de variations que peuvent prendre les données (\cite{biber:1993:representativeness-corpus-design}).
	...
	%%%
	%%% Subsection 2.1.2: Exemples de tâches d'annotation.
	%%%
