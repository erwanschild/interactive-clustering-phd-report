\chapter{Proposition d'un \textit{Clustering Interactif}}
\label{chapter:3-CLUSTERING-INTERACTIF}
    ...
    %%%%%--------------------------------------------------------------------
    \section{Description théorique de notre \textit{clustering} interactif}
