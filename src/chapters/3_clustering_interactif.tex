...
"""
		...
		\begin{enumerate}
			\item \textbf{KMeans}, dans sa version \textit{COP}\todo{citation}, noté \texttt{clust.kmeans.cop}, et sa version \textit{MPC}\todo{citation}, noté \texttt{clust.kmeans.mpc}) ;
...
"""
		...
		\todo{citation + footnote}
		\todo{travaux TPS en annexe ?}.
