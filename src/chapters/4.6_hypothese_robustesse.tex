	...
	\label{section:4.6.1-ETUDE-ROBUSTESSE-INTERETS-CORRECTION-INCOHERENCES}
		...
		\subsubsection{Protocole expérimental}
			...
			\begin{algorithm}
				...
				\KwIn{taux de différences à insérer}
				%
				\ForEach{arrangement de taux de différences à insérer}{
		...
		\subsubsection{Discussion}
			...
			\todo[inline]{A REDIGER: Discussion: convergence vers une AUTRE vérité terrain ?}
			\todo[inline]{A REDIGER: Discussion: estimer l'impact sur de ces divergences}
