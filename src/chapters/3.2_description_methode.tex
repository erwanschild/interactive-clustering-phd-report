...
\label{section:3.2-DESCRIPTION-THEORIQUE}
	...
	\label{section:3.2.1-DESCRIPTION-THEORIQUE-GENERALE}
		...
		Cette méthode, que nous appelons \texttt{Clustering Interactif} repose principalement sur l'alternance successive entre deux phases clefs (voir \textsc{Figure~\ref{figure:3.2-CLUSTERING-INTERACTIF}}) :
		\begin{itemize}
