...
\label{chapter:5-GUIDE}
	...
	\section{Présentation rapide du \textit{Clustering Interactif}}
		...
		\begin{itemize}
			...
			l'expert caractérise chaque paire de données en répondant à la question \textguillemets{\textit{est-ce que les deux données ont un cas d'usage similaire ?}}, en ajoutant une contrainte \texttt{MUST-LINK} si oui (\textit{similaires}) et en ajoutant une contrainte \texttt{CANNOT-LINK} sinon (\textit{non similaires}) ;
