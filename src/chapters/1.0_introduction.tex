...
\label{chapter:1-INTRODUCTION}
	...
	\addcontentsline{toc}{section}{
		...
		% BAM : ça va pas !
		Nous touchons alors du doigt une aberration : \textbf{comment sommes-nous arrivé à la conclusion que la meilleure manière de faire intervenir un expert métier sur une tâche d'annotation, c'est en lui demandant une tâche pour laquelle il n'est pas expert ?}
