...
\label{section:4.1-HYPOTHESE-EFFICACITE}
	...
	\label{section:4.1.1-ETUDE-CONVERGENCE}
		...
		\subsubsection{Protocole expérimental}
			...
			Pour cette étude, nous essayons une tentative pour chaque combinaison de paramètres de notre implémentation du \textit{clustering} interactif (cf. \textsc{Annexe~\ref{section:C.1-DESCRIPTION-IMPLEMENTATION-INTERACTIVE-CLUSTERING}}).
			...
			Pour plus de détails sur ces algorithmes, référez-vous à l'\textsc{Annexe~\ref{section:C.1-DESCRIPTION-IMPLEMENTATION-INTERACTIVE-CLUSTERING}} pour avoir accès à leur description, à leurs paramètres et aux choix d'implémentation.
