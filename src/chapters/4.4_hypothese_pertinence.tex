...
\label{section:4.4-HYPOTHESE-PERTINENCE}
	...
	\label{section:4.4.1-ETUDE-PERTINENCE-VERIFICATION-MANUELLE}
		...
		\subsubsection{Protocole expérimental}
			...
			\begin{algorithm}
				...
				%
				\caption{\textit{
					Description en pseudo-code du protocole expérimental de l'étude de vérification manuelle non assistée de la valeur métier d'une base d'apprentissage.
				}}
	...
	\label{section:4.4.3-ETUDE-PERTINENCE-RESUME-AUTOMATIQUE}
		...
		\subsubsection{Résultats obtenus}
			...
			\todo{commentaire Gautier: est ce que ça vaudrait le coup d'en dire plus sur cet opérateur ? (c'est toi ?). Sinon par exemple décrire son expertise (ce qui le qualifie comme compétent pour rendre un avis sur l'exploitabilité des données)}
