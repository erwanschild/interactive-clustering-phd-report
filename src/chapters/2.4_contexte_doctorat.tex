...
\label{section:2.4-CONTEXTE-DOCTORAT}
	...
	\begin{itemize}
		\item Il faut être capable de gérer le dialogue entre l'utilisateur et l'assistant (\textit{comprendre la requête initiale, demander des informations complémentaires, demander une confirmation, ...}) ;
	...
	% Transition : idée d'un clustering interactif !
	\begin{leftBarIdea}
