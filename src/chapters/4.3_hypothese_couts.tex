	...
	\label{section:4.3.1-ETUDE-COUTS-TEMPS-ANNOTATION}
		...
		\subsubsection{Résultats obtenus}
			...
			\begin{equation}
				...
				\simeq~7.77 \cdot \texttt{batch\_size}
			\end{equation}
		...
		%%	\paragraph{Analyse du temps nécessaire :}
			...
			L'étude réalisée avec $14$ annotateurs sur des lots de $1~000$ contraintes a permis d'estimer à $7.77 \cdot \texttt{batch\_size}$ le temps nécessaire (en secondes) pour annoter un lot de contraintes.
			Malgré une forte dispersion des résultats, cette modélisation permet de confirmer les tendances suivantes :
			\todo[inline]{
				Note Mathieu: ne pas disserter sur l'Intercept, ça peut juste être une erreur de modélisation.
				Déplacer ce point dans les notes de l'auteur (discussion sans preuve formelle).
				Ancienne équation à $202 + 6.92 \cdot \texttt{batch\_size}$
			}
			\begin{itemize}
				\item Nous avons un \textbf{coût fixe} (environ $200$ secondes, soit $3.33$ minutes), qui peut représenter une partie du temps d'adaptation nécessaire à l'opérateur pour commencer sa tâche \todo{citation: Anderson (2013)} : cela comprend le temps de s'habituer à la tâche et de (ré)intégrer le contexte du sujet traité ;
				\item Nous avons un \textbf{coût variable faible} (inférieur à $8$ secondes par contrainte), qui concorde avec l'hypothèse d'une caractérisation rapide d'une similitude ou d'une différence entre deux données \todo{citation: Kahneman (2011), Hancock (1988)}.
			\end{itemize}
	...
	\label{section:4.3.2-ETUDE-COUTS-TEMPS-CALCUL}
		...
		\subsubsection{Résultats obtenus}
			...
			\begin{equation}
				...
				\simeq~6.55 \cdot 10^{-3} \cdot \texttt{dataset\_size}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~-9.16 \cdot 10^{-5} \cdot \texttt{dataset\_size}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~4.62 \cdot 10^{-3} \cdot \texttt{dataset\_size}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~1.45 \cdot 10^{-1} \cdot \texttt{dataset\_size}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~-5.00 \cdot 10^{-4} \cdot \texttt{dataset\_size}^{2}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~-4.99 \cdot 10^{-4} \cdot \texttt{dataset\_size}^{2}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~-8.51 \cdot 10^{-4} \cdot \texttt{dataset\_size}^{2}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~-5.30 \cdot 10^{-4} \cdot \texttt{dataset\_size}^{2}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~8.18 \cdot 10^{-6} \cdot \texttt{dataset\_size}^{2}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~-8.20 \cdot 10^{-7} \cdot \texttt{dataset\_size}^{2}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~1.85 \cdot 10^{-7} \cdot \texttt{dataset\_size}^{2}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~5.19 \cdot 10^{-7} \cdot \texttt{dataset\_size}^{2}
			\end{equation}
			...
			\begin{equation}
				...
				\simeq~1.43 \cdot 10^{-6} \cdot \texttt{dataset\_size}^{2}
			\end{equation}
		...
		\subsubsection{Discussion}
			...
			\begin{equation}
				...
				\simeq~1.52 \cdot 10^{-1} \cdot \texttt{dataset\_size} + 1.43 \cdot 10^{-6} \cdot \texttt{dataset\_size}^{2}
			\end{equation}
	...
	\label{section:4.3.3-ETUDE-COUT-NOMBRE-CONTRAINTES}
		...
		\subsubsection{Résultats obtenus}
			...
			\begin{equation}
				...
				\simeq~3.15 \cdot \texttt{dataset\_size}
			\end{equation}
			%
			...
			\begin{equation}
				...
				\begin{cases}
					...
					\texttt{one\_iteration\_time}~[s]&
						~\simeq~\texttt{computation\_time} + \texttt{annotation\_time} \\
				\end{cases}
			\end{equation}
