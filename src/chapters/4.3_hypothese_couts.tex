...
\label{section:4.3-HYPOTHESE-COUTS}
	...
	\label{section:4.3.1-ETUDE-COUTS-TEMPS-ANNOTATION}
		...
		\subsubsection{Protocole expérimental}
			...
			Une description plus détaillée de l'application et de ses fonctionnalités est disponible en \textsc{Annexe~\ref{annex:C.3-DESCRIPTION-IMPLEMENTATION-INTERACTIVE-CLUSTERING-GUI}}.
			%
			\begin{figure}[!htb]
				\centering
