...
%\label{annex:B-ANNEXE-TECHNIQUE}
	...
	%%%%%--------------------------------------------------------------------
	%%%%% Annexe B.1: Méthodes d'évaluation d'un \textit{clustering}.
	%%%%%--------------------------------------------------------------------
	%\section{Méthodes d'évaluation d'un \textit{clustering}}
	%\label{annex:B.1-TECHNIQUE-EVALUATION-CLUSTERING}
...
%%%%%--------------------------------------------------------------------
%%%%% Annexe C: ANNEXE DEVELOPPEMENTS
%%%%%--------------------------------------------------------------------
%\Annex{Développements Python}
%\label{annex:C-ANNEXE-DEVELOPPEMENTS}
	...
	%%%%%--------------------------------------------------------------------
	%%%%% Annexe C.1: Interactive Clustering GUI.
	%%%%%--------------------------------------------------------------------
	%\section{Interactive Clustering GUI}
	%\label{annex:C.1-DEVELOPPEMENTS-INTERACTIVE-CLUSTERING-GUI}
