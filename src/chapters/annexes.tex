...
\label{annex:A-ANNEXE-DATASET}
	...
	%%%%%--------------------------------------------------------------------
	%%%%% Annexe A.1: \texttt{Bank Cards}: French trainset for chatbots dealing with usual requests on bank cards
	%%%%%--------------------------------------------------------------------
...
%%%%%--------------------------------------------------------------------
\Annex{Concevoir un assistant conversationnel (chatbot)}
\label{annex:B-ANNEXE-CHATBOT}
	...
	Dans cette annexe, nous allons détailler brièvement les fonctionnalités et architectures de chatbots.
		\cite{costello:2019:gartner-top-technologies} et \cite{goasduff:2019:chatbots-will-appeal}% gartner top technologies
	...
	%%%%%--------------------------------------------------------------------
	%%%%% Annexe B.1: Fonctionnalités connues des chatbots.
	%%%%%--------------------------------------------------------------------
	...
	\label{annex:B.1-CHATBOT-FONCTIONNALITES}
		...
		\paragraph{Chatbot \textguillemets{task-oriented}}
		\todo[inline]{A REDIGER}
			\cite{internet:2018:keyword-research-competitor} % exemple
			% exemple SNCF ?
	
		\paragraph{Chatbot \textguillemets{chat-oriented}}
		\todo[inline]{A REDIGER}
			% exemple Eliza ?
	...
	\label{annex:B.2-CHATBOT-ARCHITECTURES}
		...
		\todo[inline]{A REDIGER}
			...
			\cite{openai:2023:chatgpt} % exemple
			\cite{perpetual, non-exclusive license} % exemple
			\cite{touvron-etal:2023:llama-open-foundation} % exemple
			\cite{kaddour-etal:2023:challenges-applications-large} % plusieurs challenge
